...
export interface ProductCreatePropertySectionProps
...
export const ProductCreatePropertySectionElement: FC<ProductCreatePropertySectionProps> =
  memo((props) => {
...
ProductCreatePropertySectionElement.displayName =
