...
interface PropertyTableListActionProps extends HTMLAttributes<HTMLDivElement> {
...
export const PropertyTableAction: FC<PropertyTableListActionProps> = memo(
  (props) => {
...
PropertyTableAction.displayName = "PropertyTableAction";
