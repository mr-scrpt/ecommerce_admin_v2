...
import { ConsumerColumnType, StaffColumnType } from "../../_type/table.type";
...
export const ConsumerTableAction: FC<UserTableListActionProps> = memo(
  (props) => {
...
ConsumerTableAction.displayName = "UserTableAction";
