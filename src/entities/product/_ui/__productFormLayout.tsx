...
import { ProductForm } from "./__productForm";
...
interface ProductFormLayoutProps extends HTMLAttributes<HTMLFormElement> {
  ...
  isPending: boolean;
  submitText: string;
  categorySelectOptionList: Array<ProductDefaultSelectOption>;
  categotySelectOptionListActive?: Array<ProductDefaultSelectOption>;
  ...
  handleCategorySelectOption: (
    itemList: Array<ProductDefaultSelectOption>,
